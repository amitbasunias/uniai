...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Generate a very short brand mission for this brand using these details: ".$usertitle." ".$usertext.".";
	...
	if ($output == "1") {
		...
		echo "<p><strong>Brand Mission #1</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Brand Mission #2</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Brand Mission #3</strong></p>".aiContent();
	}
