...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Write a clickbait email for this topic using these details: ".$usertitle." ".$usertext.".";
	...
	if ($output == "1") {
		...
		function aiContent() {
			...
			$prompt = "Write a clickbait email for this topic using these details:"."\r\n"."Topic: ".$usertitle."\r\n"."About:".$usertext."\r\n".$tone."Clickbait Email:\r\n";
		...
		echo "<p><strong>Clickbait (Cold outreach email) #1</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Clickbait (Cold outreach email) #2</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Clickbait (Cold outreach email) #3</strong></p>".aiContent();
	}
