...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Write a subject for 'Confirmation Email' using these details and then write a 'Confirmation Email' using these details: ".$usertitle." ".$usertext.".";
	...
	if ($output == "1") {
		...
		echo "<p><strong>Confirmation Email #1</strong></p><br/><br/> <strong>Subject:</strong> ".aiContent()."<br/><br/>";
		echo "<p><strong>Confirmation Email #2</strong></p><br/><br/> <strong>Subject:</strong> ".aiContent()."<br/><br/>";
		echo "<p><strong>Confirmation Email #3</strong></p><br/><br/> <strong>Subject:</strong> ".aiContent();
	}
