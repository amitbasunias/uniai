...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Write a call to action for this Product/Website/Service using the following details: ".$usertitle." ".$usertext.".";
	...
	if ($output == "1") {
		...
		echo "<p><strong>Call To Action #1</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Call To Action #2</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Call To Action #3</strong></p>".aiContent();
	}
