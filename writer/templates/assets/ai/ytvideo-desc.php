...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Write a description for YouTube video using the following details: ".$usertitle." ".$usertext.".";
	...
	if ($output == "1") {
		...
		echo "<p><strong>YouTube Video Description #1</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>YouTube Video Description #2</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>YouTube Video Description #3</strong></p>".aiContent();
	}
