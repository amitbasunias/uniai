...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Write a statement that clearly identifies the value proposition of a brand, product, or service to its clients using the following details: ".$usertitle." ".$usertext.".";
	...
	if ($output == "1") {
		...
		echo "<p><strong>Value Proposition #1</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Value Proposition #2</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Value Proposition #3</strong></p>".aiContent();
	}
