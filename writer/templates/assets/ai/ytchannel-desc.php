...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Write a detailed description about YouTube video channel using the following details: ".$usertitle." ".$usertext.".";
	...
	if ($output == "1") {
		...
		function aiContent() {
			...
			$prompt = "Write a detailed description about YouTube video channel using the following details:"."\r\n"."Channel: ".$usertitle."\r\n"."About:".$usertext."\r\n".$tone;
		...
		echo "<p><strong>YouTube Channel Description #1</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>YouTube Channel Description #2</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>YouTube Channel Description #3</strong></p>".aiContent();
	}
