...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Paraphrase this content: ".$usertext.".";
	...
	if ($output == "1") {
		...
		echo "<p><strong>Paraphraser #1</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Paraphraser #2</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Paraphraser #3</strong></p>".aiContent();
	}
