...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Generate a Classified Ad along with the Call-To-Action using these details: ".$usertitle." ".$usertext.".";
	...
	if ($output == "1") {
		...
		echo "<p><strong>Classified Ad #1</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Classified Ad #2</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Classified Ad #3</strong></p>".aiContent();
	}
