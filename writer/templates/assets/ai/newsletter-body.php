...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Write a detailed, very long Newsletter Body along with the Call to Action using these details: ".$usertitle." ".$usertext.".";
	...
	if ($output == "1") {
		...
		echo "<p><strong>Newsletter Body #1</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Newsletter Body #2</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Newsletter Body #3</strong></p>".aiContent();
	}
