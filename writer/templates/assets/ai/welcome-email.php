...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Write a subject for 'Welcome Email' using these details and then write a 'Welcome Email' using these details: ".$usertitle." ".$usertext.".";
	...
	if ($output == "1") {
		...
		function aiContent() {
			...
			$prompt = "Write a subject for 'Welcome Email' using these details and then write a 'Welcome Email' using these details:"."\r\n"."Brand: ".$usertitle."\r\n"."About:".$usertext."\r\n".$tone."Subject:";
		...
		echo "<p><strong>Welcome Email #1</strong></p><br/><br/> <strong>Subject:</strong> ".aiContent()."<br/><br/>";
		echo "<p><strong>Welcome Email #2</strong></p><br/><br/> <strong>Subject:</strong> ".aiContent()."<br/><br/>";
		echo "<p><strong>Welcome Email #3</strong></p><br/><br/> <strong>Subject:</strong> ".aiContent();
	}
