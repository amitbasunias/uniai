...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Write a product description to launch on the Product Hunt website using the following details: " .$usertitle." ".$usertext.".";
	...
	if ($output == "1") {
		...
		echo "<p><strong>Product Hunt launch #1</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Product Hunt launch #2</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Product Hunt launch #3</strong></p>".aiContent();
	}
