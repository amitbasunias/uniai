...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Write a detailed cold call phone script along with thank you closing to business owners using these details: ".$usertitle." ".$usertext.".";
	...
	if ($output == "1") {
		...
		echo "<p><strong>Cold Calling Script #1</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Cold Calling Script #2</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Cold Calling Script #3</strong></p>".aiContent();
	}
