...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Write a response based on this details ".$usertext.".";
    ...
    function aiContent() {
			...
			$prompt = "Write a response based on this details:\r\n"."details: ".$usertext.".\r\n".$tone."Response:\r\n";
		...
		echo "<p><strong>Review Response #1</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Review Response #2</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Review Response #3</strong></p>".aiContent();
	}
