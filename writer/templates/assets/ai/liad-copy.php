...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Generate a LinkedIn Ad Copy along with the Call To Action for this brand, product, or service using these details: ".$usertitle." ".$usertext.".";
	...
	if ($output == "1") {
		...
		echo "<p><strong>LinkedIn Ad Copy #1</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>LinkedIn Ad Copy #2</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>LinkedIn Ad Copy #3</strong></p>".aiContent();
	}
