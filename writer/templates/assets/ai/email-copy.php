...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Write a subject for 'Marketing Email' using these details and then write a 'Marketing Email' to a customer using these details: ".$usertitle." ".$usertext.".";
	...
	if ($output == "1") {
		...
		function aiContent() {
			...
			$prompt = "Write Email Subject and a Marketing Email to a customer".$templatestyle." using these details:"."\r\n"."Product:".$usertitle."\r\n"."About: ".$usertext.".\r\n".$tone."Email Subject:\r\n";
		...
		echo "<p><strong>Email sales copy #1</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Email sales copy #2</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Email sales copy #3</strong></p>".aiContent();
	}
