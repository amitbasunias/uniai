...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Generate Title, Introduction, Table of Contents, Continue to expand each Table of Contains into 5 to 10 paragraphs using the following details:"." "."Topic: ".$usertitle." "."Focused keywords: ".$usertext.".";
