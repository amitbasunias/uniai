...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Write a customer review about this product: ".$usertext.".";
    ...
    function aiContent() {
		...
		echo "<p><strong>Product Review for a Seller #1</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Product Review for a Seller #2</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Product Review for a Seller #3</strong></p>".aiContent();
	}
