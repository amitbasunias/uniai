...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Generate a headline for the Ad copy for this brand, product, or service using these details: ".$usertitle." ".$usertext.".";
	...
	if ($output == "1") {
		...
		echo "<p><strong>Ad Headline #1</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Ad Headline #2</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Ad Headline #3</strong></p>".aiContent();
	}
