...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Write a meta description using the following details: ".$usertext.".";
	...
	if ($output == "1") {
		...
		echo "<p><strong>Meta Description #1</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Meta Description #2</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Meta Description #3</strong></p>".aiContent();
	}
