...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Generate a Facebook Primary Text along with the Call To Action for this brand, product, or service using these details: ".$usertitle." ".$usertext.".";
	...
	if ($output == "1") {
		...
		echo "<p><strong>Facebook Headline #1</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Facebook Headline #2</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Facebook Headline #3</strong></p>".aiContent();
	}
