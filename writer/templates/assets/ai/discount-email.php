...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Write a subject for 'Coupon or Discount Email' using these details and then write a 'Coupon or Discount Email' using these details: ".$usertitle." ".$usertext.".";
	...
	if ($output == "1") {
		...
		echo "<p><strong>Coupon or Discount Email #1</strong></p><br/><br/> <strong>Subject:</strong> ".aiContent()."<br/><br/>";
		echo "<p><strong>Coupon or Discount Email #2</strong></p><br/><br/> <strong>Subject:</strong> ".aiContent()."<br/><br/>";
		echo "<p><strong>Coupon or Discount Email #3</strong></p><br/><br/> <strong>Subject:</strong> ".aiContent();
	}
