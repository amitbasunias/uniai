...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Generate a brand name for this: ".$usertext.".";
	...
	if ($output == "1") {
		...
		echo "<p><strong>Brand Name #1</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Brand Name #2</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Brand Name #3</strong></p>".aiContent();
	}
