...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Write an ad copy along with the Call To Action for this brand, product, or service using these details: ".$usertitle." ".$usertext.".";
	...
	if ($output == "1") {
		...
		echo "<p><strong>General Ad Copy #1</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>General Ad Copy #2</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>General Ad Copy #3</strong></p>".aiContent();
	}
