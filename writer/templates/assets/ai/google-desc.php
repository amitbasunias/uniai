...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Write an ad description along with the Call To Action for this brand, product, or service using these details. Must be finished within 158 characters: " .$usertitle." ".$usertext.".";
	...
	if ($output == "1") {
		...
		echo "<p><strong>Google Description #1</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Google Description #2</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Google Description #3</strong></p>".aiContent();
	}
