...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Write an introduction from this blog article: ".$usertext.".";
	...
	if ($output == "1") {
		...
		echo "<p><strong>Blog Intro #1</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Blog Intro #2</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Blog Intro #3</strong></p>".aiContent();
	}
