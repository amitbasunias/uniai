...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Write a subject for 'Follow Up Email' using these details and then write a 'Follow Up Email' using these details: ".$usertitle." ".$usertext.".";
	...
	if ($output == "1") {
		...
		function aiContent() {
			...
			$prompt = "Write a subject for 'Follow Up Email' using these details and then write a 'Follow Up Email' using these details:"."\r\n"."Brand: ".$usertitle."\r\n"."About:".$usertext."\r\n".$tone."Subject:";
		...
		echo "<p><strong>Follow Up Email #1</strong></p><br/><br/> <strong>Subject:</strong> ".aiContent()."<br/><br/>";
		echo "<p><strong>Follow Up Email #2</strong></p><br/><br/> <strong>Subject:</strong> ".aiContent()."<br/><br/>";
		echo "<p><strong>Follow Up Email #3</strong></p><br/><br/> <strong>Subject:</strong> ".aiContent();
	}
