...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Generate a very short brand slogan for this brand using these details: ".$usertitle." ".$usertext.".";
	...
	if ($output == "1") {
		...
		echo "<p><strong>Slogan #1</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Slogan #2</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Slogan #3</strong></p>".aiContent();
	}
