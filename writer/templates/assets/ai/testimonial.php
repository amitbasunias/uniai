...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Write a detailed testimonial about this Product/Website/Service using the following details: ".$usertitle." ".$usertext.".";
	...
	if ($output == "1") {
		...
		echo "<p><strong>Testimonial #1</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Testimonial #2</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Testimonial #3</strong></p>".aiContent();
	}
