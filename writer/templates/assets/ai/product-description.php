...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Write a vary detailed, long product description to a customer for the following product: ".$usertext.".";
	...
	if ($output == "1") {
		...
		function desc() {
			...
			$prompt = "Write a vary detailed, long product description to a customer for the following product".$templatestyle.":\r\nProduct:".$usertext.".\r\n".$tone.$templatetext;
		...
		echo '<p><strong>Bullet Points:</strong></p>'.points();
		...
		echo '<br><br><br><p><strong>'.$templatetext.'</strong></p>'.desc();
	}
