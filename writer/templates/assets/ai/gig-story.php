...
if (isset($_POST["submit"])) {
	...
	if ($output == "1") {
		...
		echo '<p><strong>Seller story in one line #1:</strong></p>'.tagLine();
		echo '<p><strong>Seller story in one line #2:</strong></p>'.tagLine();
		echo '<p><strong>Seller story in one line #3:</strong></p>'.tagLine();
	}
