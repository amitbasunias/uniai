...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$ab = $_POST["ab"];
		$num = $_POST["num"];
		$prompt = "Generate ".$num." multiple-choice questions and answers based on my target audience and question: Target Audience: ".$usertitle." "."Question: ".$qa." "."Sample questions: ".$aa." ".$qb." ".$num." multiple-choice questions answers:";
