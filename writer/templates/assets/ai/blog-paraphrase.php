...
if (isset($_POST["submit"])) {
    ...
    function openAI() {
		...
		$prompt = "Paraphrase sentence: ".$usertext.".";
	...
	if ($output == "1") {
		...
		echo "<p><strong>Sentence Rewriter #1</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Sentence Rewriter #2</strong></p>".aiContent()."<br/><br/>";
		echo "<p><strong>Sentence Rewriter #3</strong></p>".aiContent();
	}
